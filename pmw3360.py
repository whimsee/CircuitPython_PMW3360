...
REG_Maximum_Raw_data                     = 0x09
REG_Minimum_Raw_data                     = 0x0A
...
REG_Rest1_Rate_Lower                     = 0x15
REG_Rest1_Rate_Upper                     = 0x16
REG_Rest1_Downshift                      = 0x17
REG_Rest2_Rate_Lower                     = 0x18
REG_Rest2_Rate_Upper                     = 0x19
REG_Rest2_Downshift                      = 0x1A
REG_Rest3_Rate_Lower                     = 0x1B
REG_Rest3_Rate_Upper                     = 0x1C
REG_Observation                          = 0x24
REG_Data_Out_Lower                       = 0x25
REG_Data_Out_Upper                       = 0x26
REG_Raw_Data_Dump                        = 0x29
REG_SROM_ID                              = 0x2A
REG_Min_SQ_Run                           = 0x2B
REG_Raw_Data_Threshold                   = 0x2C
REG_Config5                              = 0x2F
REG_Power_Up_Reset                       = 0x3A
REG_Shutdown                             = 0x3B
REG_Inverse_Product_ID                   = 0x3F
REG_LiftCutoff_Tune3                     = 0x41
REG_Angle_Snap                           = 0x42
REG_LiftCutoff_Tune1                     = 0x4A
REG_Motion_Burst                         = 0x50
REG_LiftCutoff_Tune_Timeout              = 0x58
REG_LiftCutoff_Tune_Min_Length           = 0x5A
REG_SROM_Load_Burst                      = 0x62
REG_Lift_Config                          = 0x63
REG_Raw_Data_Burst                       = 0x64
REG_LiftCutoff_Tune2                     = 0x65
...
class PMW3360:
    ...
    def begin(self, cpi=800):
        ...
        self.read_reg(REG_Delta_Y_L)
        self.read_reg(REG_Delta_Y_H)
    ...
    def read_burst(self):
        ...
        if not self.in_burst or from_last > 500:
            self.write_reg(REG_Motion_Burst, 0x00)
            self.in_burst = True
    ...
    def prepare_image(self):
        ...
        self.write_reg(REG_Frame_Capture, 0x83)
        self.write_reg(REG_Frame_Capture, 0xc5)
